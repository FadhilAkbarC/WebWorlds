...
exports.commentController = {
    getGameComments: (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    createComment: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        if (!req.userId) {
        ...
        if (!text || text.trim().length === 0) {
            throw new errorHandler_1.AppError(400, 'Comment text is required');
        }
        if (text.length > 500) {
            throw new errorHandler_1.AppError(400, 'Comment must be 500 characters or less');
        }
    ...
    deleteComment: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        if (!req.userId) {
            throw new errorHandler_1.AppError(401, 'Not authenticated');
        }
        ...
        if (!comment) {
            throw new errorHandler_1.AppError(404, 'Comment not found');
        }
        if (comment.userId.toString() !== req.userId) {
            throw new errorHandler_1.AppError(403, 'Not authorized to delete this comment');
        }
    ...
    likeComment: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        if (!req.userId) {
            throw new errorHandler_1.AppError(401, 'Not authenticated');
        }
        const { commentId } = req.params;
        ...
        if (comment.likedBy.includes(req.userId)) {
            throw new errorHandler_1.AppError(409, 'Already liked this comment');
        }
        comment.likes += 1;
    ...
    unlikeComment: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        if (!req.userId) {
            throw new errorHandler_1.AppError(401, 'Not authenticated');
        }
        const { commentId } = req.params;
        ...
        if (likedIndex === -1) {
            throw new errorHandler_1.AppError(409, 'Haven\'t liked this comment');
        }
