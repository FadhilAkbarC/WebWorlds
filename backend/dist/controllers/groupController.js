...
exports.groupController = {
    ...
    get: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        ...
        if (!mongoose_1.default.Types.ObjectId.isValid(id)) {
            throw new errorHandler_1.AppError(400, 'Invalid group id');
        }
        ...
        if (group.privacy === 'private' && !isMember) {
            throw new errorHandler_1.AppError(403, 'Group is private');
        }
    ...
    create: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        ...
        if (!name) {
            throw new errorHandler_1.AppError(400, 'Group name is required');
        }
        if (!validation_1.validators.title(name)) {
            throw new errorHandler_1.AppError(400, 'Group name must be 3-100 characters');
        }
        ...
        if (privacy !== 'public' && privacy !== 'private') {
            throw new errorHandler_1.AppError(400, 'Invalid privacy setting');
        }
        if (icon) {
            const isDataUrl = icon.startsWith('data:image/');
            if (!isDataUrl && !validation_1.validators.url(icon)) {
                throw new errorHandler_1.AppError(400, 'Invalid icon URL');
            }
        }
    ...
    join: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        if (!req.userId) {
            throw new errorHandler_1.AppError(401, 'Not authenticated');
        }
        const { id } = req.params;
    ...
    leave: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        if (!req.userId) {
            throw new errorHandler_1.AppError(401, 'Not authenticated');
        }
        const { id } = req.params;
    ...
    mine: (0, errorHandler_1.asyncHandler)(async (req, res) => {
        if (!req.userId) {
            throw new errorHandler_1.AppError(401, 'Not authenticated');
        }
