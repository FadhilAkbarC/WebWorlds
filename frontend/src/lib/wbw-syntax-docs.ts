...
export const WBW_SYNTAX_TOPICS: WBWSyntaxTopic[] = [
  ...
  },
  {
    ...
    notes: 'Shortcut untuk percabangan kebalikan tanpa menulis negasi manual.',
  },
  {
    id: 'touch-controls',
    ...
    aliases: ['TOUCH variable'],
    example: 'touch on',
    notes: 'Aktifkan kontrol sentuh untuk device tanpa keyboard. Auto = aktif saat touch terdeteksi.',
  },
  {
    id: 'input',
    title: 'Input Binding',
