      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-800 rounded-lg border border-slate-700 p-8 space-y-6 text-slate-300 text-sm">
          ...
          <section>
            ...
            <p className="mb-2">Permission is granted to temporarily download one copy of the materials (information or software) 
            on WebWorlds for personal, non-commercial transitory viewing only. This is the grant of a license, 
          ...
          <section>
            ...
            <p>
              In no event shall WebWorlds or our suppliers be liable for any damages (including, without limitation, 
          ...
          <section>
            ...
            <p>
              The materials appearing on WebWorlds could include technical, typographical, or photographic errors. 
          ...
          <section>
            ...
            <p>
              ...
              in which WebWorlds operates, and you irrevocably submit to the exclusive jurisdiction of the courts in 
              that location.
            </p>
          </section>
